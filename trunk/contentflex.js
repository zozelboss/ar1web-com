$(document).ready(function() {
    ...
    var stickyNav = function(){
        ...
        if (scrollTop > stickyNavTop) { 
            $('#menu-wrapper').css({ 'position': 'fixed', 'top':0, 'left':0, 'z-index':9999 });
        } else {
